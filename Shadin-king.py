# code by Shadin Obroy
# my facebook ( https://www.facebook.com/YOUR.NEXT.FU3K.ABBU.S4AD1N )

#      (C) Copyright 407 Authentic Exploit
#      Rebuild Copyright Can't make u real programmer:)
#      Coded By Shadin Onroy.
...
\__/\/ /_/\_/ \_/___,'\____/\_\ \/  
    ...
    print("╔════════════════════════════════════════╗")
    print(f"║{P}[{H}•{P}] Author    : SHADIN                   {N}║")
    print(f"║{P}[{H}•{P}] Whatsapp  : +8801812775755           {N}║")
